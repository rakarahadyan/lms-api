...
$result = [];
$sql_one = "SELECT * FROM courses ORDER BY id DESC LIMIT 1";
...
$query_two->execute();
$result["modul"] = $query_two->fetchAll(PDO::FETCH_ASSOC);

$sql_three = "SELECT s.*, c.title as course_title, u.name as user_name 
    FROM scores s 
